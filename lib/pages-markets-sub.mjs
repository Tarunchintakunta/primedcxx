...
export const pagesMarketsSub = {
  ...
  <section class="sec sec--line">
    <div class="sec__head rv">
      ...
      <p class="sec__sub">60+ pairs stream inside the platform. A sample of what you'll find across majors, minors and exotics.</p>
    </div>
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">60+</div><h3>Full currency coverage</h3><p>Majors, minors and exotics in one account, one interface.</p></div>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>BTC, ETH and major altcoins - long or short, 24/7, with no wallets and no custody risk.
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      <div class="fcard rv"><div class="fcard__ic">&#8645;</div><h3>Long or short</h3><p>Take a position either direction - crypto CFDs don't require you to hold the underlying asset.</p></div>
      ...
      <div class="fcard rv"><div class="fcard__ic">24/7</div><h3>Always open</h3><p>Crypto never closes on PRIME DCX - trade weekends and holidays alike.</p></div>
  ...
  <section class="phero">
    ...
    <p>Tight spreads and reliable depth on the classic hedge - one click away from your FX book.</p>
  </section>
  ...
  <section class="phero">
    ...
    <p>Trade global market indices through index CFDs, from micro size upward - a single position
  ...
  <section class="phero">
    ...
    <p>CFD trading on global stocks and shares is coming to PRIME DCX - the same execution
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">0</div><h3>Zero custody overhead</h3><p>No brokerage account transfers, no settlement delays - a CFD, not a share purchase.</p></div>
    </div>
  </section>
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20Stocks%20CFDs">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">MARKETS <span class="badge-soon">COMING SOON</span></p>
    <h1>Bonds CFDs</h1>
    <p>Government and corporate bond CFDs are on the roadmap - a way to position on interest-rate
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20Bonds%20CFDs">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">MARKETS <span class="badge-soon">COMING SOON</span></p>
    <h1>Futures CFDs</h1>
    <p>Commodity and financial futures CFDs are on the roadmap - term exposure to the markets
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20Futures%20CFDs">Notify Me When Available</a>
    </div>
  </section>
