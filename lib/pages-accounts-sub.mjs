...
export const pagesAccountsSub = {
  ...
  <section class="phero">
    ...
    <p>Deposits start from $100. Funds must originate from an account held in your own name &mdash;
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">03</div><h3>Trade</h3><p>Funds post to your account and you're live &mdash; launch the Web Trader and start trading.</p></div>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    only to an account held in your own name &mdash; no third-party transfers, under our AML/CTF policy.</p>
  </section>
  ...
  <section class="phero">
    ...
    <p>An ultra-low raw spread tier is on the roadmap &mdash; interbank pricing with a transparent
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Raw%20Spread%20Account">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">ACCOUNTS <span class="badge-soon">COMING SOON</span></p>
    <h1>Demo Account</h1>
    <p>A risk-free practice account with live spreads and real-time pricing is on the roadmap &mdash;
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Demo%20Account">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>A Sharia-compliant account with no overnight financing fees is on the roadmap &mdash;
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Swap-Free%20Account">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">ACCOUNTS <span class="badge-soon">COMING SOON</span></p>
    <h1>PAMM Accounts</h1>
    <p>Percentage Allocation Management Module accounts are on the roadmap &mdash; proportional profit
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20PAMM%20Accounts">Notify Me When Available</a>
    </div>
  </section>
