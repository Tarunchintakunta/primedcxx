...
export const pagesConditions = {
  ...
  <section class="phero">
    ...
    <p>Spreads, hours and leverage - published, specific, and consistent across every account until you
  ...
  <section class="sec">
    ...
    <div class="fgrid">
      ...
      <a class="fcard rv" href="/conditions/leverage/">
        <div class="fcard__ic">1:5000</div><h3>Leverage</h3>
        <p>Up to 1:5000 across every account, with margin call at 100% and stop-out at 50%.</p>
  ...
  <section class="sec sec--line">
    ...
    <div class="mtable-wrap rv">
      <table class="mtable">
        ...
        <tbody>
          <tr><td class="sym">ECN</td><td class="px">0.0 pips</td><td class="px">$7 / lot</td><td class="nm">Scalpers and high-frequency execution</td></tr>
          <tr><td class="sym">PRO</td><td class="px">0.8 pips</td><td class="px">$0</td><td class="nm">Zero-commission, straightforward trading</td></tr>
          <tr><td class="sym">PRIME</td><td class="px">0.0 pips</td><td class="px">$2 / lot</td><td class="nm">Tight spreads with lowest commission</td></tr>
        </tbody>
      </table>
    </div>
  </section>
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">24/7</div><h3>Crypto</h3><p>Digital assets trade every hour of every day, weekends included - the book never closes.</p></div>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>Leverage is set at 1:5000 across every account tier. Margin call triggers at 100% equity, stop-out
    at 50%, on every account.</p>
  </section>
  ...
  <section class="sec sec--line">
    ...
    <div class="mtable-wrap rv">
      <table class="mtable">
        ...
        <tbody>
          <tr><td class="sym">ECN</td><td class="px">1:5000</td><td class="px">100%</td><td class="px">50%</td></tr>
          <tr><td class="sym">PRO</td><td class="px">1:5000</td><td class="px">100%</td><td class="px">50%</td></tr>
          <tr><td class="sym">PRIME</td><td class="px">1:5000</td><td class="px">100%</td><td class="px">50%</td></tr>
        </tbody>
      </table>
    </div>
  </section>
