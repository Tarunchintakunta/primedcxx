...
export const pagesCompanySub = {
  ...
  <section class="phero">
    ...
    published policies covering every stage of the client relationship - before, during and after
    you trade.</p>
  </section>
  ...
  <section class="phero">
    ...
    <p>The full story of PRIME DCX - how the platform was built, who stands behind it, and what
    we're building toward - is being written. Our legal identity and compliance program are already
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20About%20Us">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    In the meantime, write to us directly - we read every message.</p>
  </section>
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20Careers">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20-%20Sponsorships">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    under their own brand - execution, back office and support, without building it from scratch.</p>
  </section>
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:partners@primedcx.com?subject=Notify%20me%20-%20White%20Label">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>Four asset classes, spreads from 0.0 pips and instant execution - live in minutes,
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">03</div><h3>Trade</h3><p>Launch the Web Trader and access 60+ pairs instantly. Withdrawals are processed automatically within 24 hours.</p></div>
    </div>
  </section>
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">38ms</div><h3>Lightning execution</h3><p>Ultra-low-latency order routing with zero requotes.</p></div>
