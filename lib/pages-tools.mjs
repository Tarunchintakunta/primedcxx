...
export const pagesTools = {
  ...
  <section class="phero">
    ...
    <p>PRIME DCX is building a full suite of trading tools alongside the platform &mdash; live market data,
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Tools">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>A live, filterable calendar of the global economic events that move forex, gold and indices &mdash;
  ...
  <section class="sec sec--line">
    ...
    <div class="fgrid">
      ...
      <div class="fcard rv"><div class="fcard__ic">&#9635;</div><h3>Built into the platform</h3><p>No separate tab or third-party feed &mdash; the calendar lives inside the same terminal you trade from.</p></div>
    </div>
  </section>
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Economic%20Calendar">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">TOOLS <span class="badge-soon">COMING SOON</span></p>
    <h1>Calculators</h1>
    <p>A complete calculator suite for sizing and planning trades before you place them &mdash; arriving
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Calculators">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p>Professional-grade market analysis, licensed directly into the platform &mdash; technical research
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Trading%20Central">Notify Me When Available</a>
    </div>
  </section>
  ...
  <section class="phero">
    ...
    <p class="phero__eyebrow mono">TOOLS <span class="badge-soon">COMING SOON</span></p>
    <h1>Copy Trading</h1>
    <p>Follow verified signal providers, or let other traders follow you &mdash; native copy trading, a
  ...
  <section class="sec" style="text-align:center">
    <div class="rv">
      ...
      <a class="btn btn--ghost btn--xl" href="mailto:support@primedcx.com?subject=Notify%20me%20%E2%80%94%20Copy%20Trading">Notify Me When Available</a>
    </div>
  </section>
